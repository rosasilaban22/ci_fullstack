    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formModalLabel">Tambah Kategori Barang</h4>
            </div>
                ...
                success: function(response) {
                    ...
                    for (i = 0; i < response.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td><center>' +
                            '<span><button edit-id="' + response[i].id_kategori + '" class="btn btn-success btn-xs btn_edit"><i class="fa fa-edit"></i> Edit</button><button style="margin-left: 5px;" data-id="' + response[i].id_kategori + '" class="btn btn-danger btn-xs btn_hapus"><i class="fa-trash"></i> Hapus</button></span>' +
                            '</center></td>' +
                            '</tr>';
                    }
                    $('#tbl_data').html(html);
